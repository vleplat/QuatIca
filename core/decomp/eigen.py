...
def quaternion_eigendecomposition(A_quat, verbose=False):
    ...
    if verbose:
        print(f"Tridiagonalization completed")
    ...
    if verbose:
        print(f"Eigendecomposition of tridiagonal matrix completed")
    ...
    if verbose:
        print(f"Eigenvectors transformed back to original space")
...
def verify_eigendecomposition(A_quat, eigenvalues, eigenvectors, verbose=False):
    ...
    if verbose:
        print(f"Eigendecomposition verification:")
