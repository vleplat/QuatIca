...
This module tests the generate_random_unitary_matrix function from quatica/data_gen.py
...
class TestRandomUnitaryMatrix(unittest.TestCase):
    ...
    def test_matrix_size(self):
        ...
        for n in sizes:
            with self.subTest(n=n):
                ...
                # Check shape
                self.assertEqual(
                    Q.shape, (n, n), f"Matrix should be {n}×{n}, got {Q.shape}"
                )
    ...
    def test_randomness(self):
        ...
        self.assertGreater(
            diff_norm, 1e-10, "Different calls should produce different matrices"
        )
