#!/usr/bin/env python3
"""
Unit tests for enhanced visualization functions in core/visualization.py
...
class TestEnhancedVisualization(unittest.TestCase):
    ...
    @patch('matplotlib.pyplot.colorbar')
    @patch('matplotlib.pyplot.imshow')
    def test_visualize_matrix_abs_with_params(self, mock_imshow, mock_colorbar, mock_show):
    ...
    @patch('matplotlib.pyplot.imshow')
    @patch('matplotlib.pyplot.colorbar')
    def test_visualize_tensor_slice_abs_vs_real(self, mock_colorbar, mock_imshow, mock_show):
    ...
    def test_visualize_schur_structure_basic(self, mock_subplots, mock_imshow, mock_colorbar, mock_show):
    ...
    @patch('matplotlib.pyplot.imshow')
    @patch('matplotlib.pyplot.subplots')
    def test_visualize_schur_structure_with_params(self, mock_subplots, mock_imshow, mock_colorbar, mock_show):
    ...
    def test_plot_convergence_comparison_logscale(self, mock_semilogy, mock_plot, mock_show):
    ...
    @patch('matplotlib.pyplot.plot')
    @patch('matplotlib.pyplot.semilogy')
    def test_plot_convergence_comparison_linear(self, mock_semilogy, mock_plot, mock_show):
    ...
    @patch('matplotlib.pyplot.semilogy')
    def test_plot_convergence_comparison_save(self, mock_semilogy, mock_savefig, mock_show):
    ...
    def test_visualize_schur_structure_identity(self):
        ...
        with patch('matplotlib.pyplot.show'), \
            ...
            below_diag_max, subdiag_max = Visualizer.visualize_schur_structure(self.identity)
