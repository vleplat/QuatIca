...
def test_qgmres_well_conditioned_3x3():
    ...
    b = np.array([[quaternion.quaternion(1.0, 0.0, 0.0, 0.0)],
                  ...
                  [quaternion.quaternion(0.0, 0.0, 1.0, 0.0)]], dtype=np.quaternion)
...
def test_qgmres_identity_system():
    ...
    assert residual_qgmres < 1e-10, f"Q-GMRES residual too large for identity system: {residual_qgmres}"
