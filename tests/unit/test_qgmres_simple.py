...
def test_simple_identity():
    ...
    b = np.array([[quaternion.quaternion(1.0, 0.0, 0.0, 0.0)],
                  [quaternion.quaternion(0.0, 1.0, 0.0, 0.0)]], dtype=np.quaternion)
...
def test_simple_diagonal():
    ...
    # Create right-hand side
    b = np.array([[quaternion.quaternion(2.0, 0.0, 0.0, 0.0)],
                  [quaternion.quaternion(3.0, 0.0, 0.0, 0.0)]], dtype=np.quaternion)
    ...
    expected_solution = np.array([[quaternion.quaternion(1.0, 0.0, 0.0, 0.0)],
                                 [quaternion.quaternion(1.0, 0.0, 0.0, 0.0)]], dtype=np.quaternion)
    print(f"Expected solution:\n{expected_solution}")
