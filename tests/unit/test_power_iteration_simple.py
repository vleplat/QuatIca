...
from utils import power_iteration, quat_frobenius_norm, quat_hermitian, quat_matmat
...
def test_power_iteration_vs_eigendecomposition():
    ...
    test_cases = [(4, "Small matrix"), (8, "Medium matrix"), (12, "Large matrix")]
    ...
    for size, description in test_cases:
        ...
        dominant_eigenvector = eigenvectors[
        ...
        print(
            f"Eigenvalue difference: {abs(power_eigenvalue - abs(dominant_eigenvalue)):.2e}"
        )
